...
export const GET: APIRoute = ({ site }) => {
  ...
  const lines = [
    ...
    '',
    `Home: ${absolute('/')}`,
    `About & Evolution: ${absolute('/about.html')}`,
    `AE System Summary: ${absolute('/about/system-summary.html')}`,
    `Decision Register: ${absolute('/about/decisions.html')}`,
    `Experiments & Learnings: ${absolute('/about/experiments.html')}`,
    ...
    '- The System Summary is the concise current explanation of what AE is, its lifecycle, required capability kinds, and portability model.',
    '- The Decision Register preserves consequential reasoning and uses explicit supersession rather than rewriting prior decisions.',
    '- Experiments & Learnings keeps intentionally unsettled questions visible and records evidence, conclusions, and resulting system updates.',
    '',
    '## Start Here',
